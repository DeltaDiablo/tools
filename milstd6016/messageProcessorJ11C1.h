#ifndef MILSTD6016_MESSAGEPROCESSORJ11C1_H_
#define MILSTD6016_MESSAGEPROCESSORJ11C1_H_
...
using J11C1FieldValue = WordFieldValue;
using J11C1Message = WordMessage;
