...
constexpr FieldMeta kX20Jstn{"JRE Source Track Number", "DFI3027 DUI003"};
constexpr FieldMeta kX20Npg{"JTIDS/MIDS Participation Group", "DFI3040 DUI001"};
constexpr FieldMeta kX20Blocks{"Number of Blocks", "DFI3033 DUI004"};
constexpr FieldMeta kX70SourceLinkDesignator{"Source Link Designator", "DFI3021 DUI003"};
constexpr FieldMeta kX70TransmitLinkDesignator{"Transmit Link Designator", "DFI3021 DUI004"};
constexpr FieldMeta kX70Npg{"Network Participation Group", "DFI3040 DUI001"};
constexpr FieldMeta kX70Spare7{"Spare (7 bits)", "Reserved"};
...
constexpr const char* kDispatchX200Decode = "X2.0.0 decode";
constexpr const char* kDispatchX20SectionPrefix = "Coded Free Text Block ";
constexpr const char* kDispatchX20TrailingBitsPrefix = "Trailing payload bits not forming a full X2.0 block: ";
constexpr const char* kDispatchX300Decode = "X3.0.0 decode";
constexpr const char* kDispatchX30SectionPrefix = "Uncoded Free Text Block ";
constexpr const char* kDispatchX30TrailingBitsPrefix = "Trailing payload bits not forming a full X3.0 block: ";
constexpr const char* kDispatchX70Detected = "X7.0 message detected.";
constexpr const char* kDispatchX700Decode = "X7.0.0 decode";
constexpr const char* kDispatchX70SectionPrefix = "NPG Assignment Message ";
constexpr const char* kDispatchX70TrailingBitsPrefix = "Trailing payload bits not forming a full X7.0 section: ";
